...
# Check environment
echo -e "${YELLOW}[1/5]${NC} Checking environment..."
...
echo -e "${YELLOW}[2/5]${NC} Generating configurations..."
cd frontend
...
echo -e "${YELLOW}[3/5]${NC} Pre-compiling dependencies..."
cd backend
...
echo -e "${YELLOW}[4/5]${NC} Starting backend with optimized hot reload..."
cd backend
...
echo -e "${YELLOW}[5/5]${NC} Starting frontend with optimized hot reload..."
cd frontend
